...
- (void).cxx_destruct;	// IMP=0x000000010007d9e4
...
- (_Bool)validateAfterStartWithAuditTokens:(id)arg1;	// IMP=0x000000010007d89c
@property(readonly) _Bool isPerUser;
- (void)addUUIDs:(id)arg1;	// IMP=0x000000010007d608
- (void)setPluginPID:(int)arg1 uuids:(id)arg2;	// IMP=0x000000010007d580
- (_Bool)supportsMultipleInstancesOfExtension;	// IMP=0x000000010007d510
- (void)terminate;	// IMP=0x000000010007d47c
- (void)disposeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010007ce9c
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010007c928
- (void)sendSetupCommandWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010007c278
- (id)description;	// IMP=0x000000010007c270
- (_Bool)matchesAuditToken:(id)arg1 expectedCDHashes:(id)arg2 requiredEntitlement:(id)arg3;	// IMP=0x000000010007c268
- (id)initWithPluginType:(id)arg1 pluginVersion:(long long)arg2 pluginClass:(long long)arg3 pluginInfo:(id)arg4 userID:(id)arg5;	// IMP=0x000000010007c108
