...
- (void).cxx_destruct;	// IMP=0x00000001000885c8
...
- (void)setPowerState:(long long)arg1;	// IMP=0x0000000100088254
- (void)stop;	// IMP=0x00000001000881cc
- (_Bool)start;	// IMP=0x0000000100087f6c
- (void)setReadyToSleep;	// IMP=0x0000000100087d78
- (_Bool)sleepPending;	// IMP=0x0000000100087d3c
- (id)initWithDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x0000000100087c94
